...
const questions = [
  ...
  {
    question: 'Питання №1: Що таке виключення (exception) в JavaScript?',
    options: [
  ...
  {
    question: 'Питання №2: Яким чином можна обробити виключення в JavaScript?',
    options: [
  ...
  {
    question: 'Питання №3: Які переваги використання обробки виключень в JavaScript?',
    options: [
